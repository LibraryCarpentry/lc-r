...
Installing CRAN packages can be done from the Packages tab in the Navigation
tab, or from the RStudio console. Click the Packages tab in the Navigation Pane,
then click Install and search for the package you're looking for. You can also
use the `install.packages()` function directly in the console. Run
`help(install.packages)` to learn more about how to do it this way.
...
* Lisa Federer's [Introduction to R for Non-Programmers](archived at https://www.nihlibrary.nih.gov/training/introduction-r-data-wrangling-5)
