...
~~~
Error: 'data_output/books_reformatted.csv' does not exist in current working directory ('/Users/clarke/Desktop/Clarke/Work/library_carpentry/lc-r/_episodes_rmd').
~~~
{: .error}
...
~~~
Error in eval(expr, envir, enclos): object 'books2' not found
~~~
{: .error}
...
~~~
Error in eval(lhs, parent, parent): object 'books2' not found
~~~
{: .error}
...
~~~
Error in ggplot(data = booksPlot): object 'booksPlot' not found
~~~
{: .error}
...
~~~
Error in ggplot(data = booksPlot, mapping = aes(x = call_class)): object 'booksPlot' not found
~~~
{: .error}
...
~~~
Error in ggplot(data = booksPlot, mapping = aes(x = tot_chkout)): object 'booksPlot' not found
~~~
{: .error}
...
~~~
Error in table(booksPlot$tot_chkout): object 'booksPlot' not found
~~~
{: .error}
...
~~~
Error in eval(lhs, parent, parent): object 'booksPlot' not found
~~~
{: .error}
...
~~~
Error in ggplot(data = booksHighUsage, aes(x = call_class, y = tot_chkout)): object 'booksHighUsage' not found
~~~
{: .error}
...
> > 
> > ~~~
> > Error in ggplot(data = booksHighUsage, aes(x = subCollection, y = tot_chkout)): object 'booksHighUsage' not found
> > ~~~
> > {: .error}
> {: .solution}
{: .challenge}
...
~~~
Error in ggplot(data = booksHighUsage, aes(x = call_class)): object 'booksHighUsage' not found
~~~
{: .error}
...
~~~
Error in eval(expr, envir, enclos): object 'booksPlot' not found
~~~
{: .error}
...
~~~
Error in ggplot(data = yearly_counts, mapping = aes(x = pubyear_ymd, y = n)): object 'yearly_counts' not found
~~~
{: .error}
...
~~~
Error in ggplot(data = books2, aes(x = subCollection)): object 'books2' not found
~~~
{: .error}
...
> > 
> > ~~~
> > Error in ggplot(data = yearly_checkouts, mapping = aes(x = pubyear_ymd, : object 'yearly_checkouts' not found
> > ~~~
> > {: .error}
> {: .solution}
{: .challenge}
