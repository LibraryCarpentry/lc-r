...
<figure>
<img src="../fig/working-directory-structure.png" title="Structure of a Working Directory, with folders for data, data output, documents, fig output, and scripts" alt="Structure of a Working Directory, with folders for data, data output, documents, fig output, and scripts" style="display: block; margin: auto;" />
</figure>
...
<figure>
<img src="../fig/booksImport.PNG" title="The books CSV loaded as a tibble in your R environment" alt="The books CSV loaded as a tibble in your R environment" style="display: block; margin: auto;" />
<figcaption>
...
<figure>
<img src="../fig/data-frame.svg" title="A graphical depiction of a data frame. The first vector (column) is numeric; the second is character, and the third is logical." alt="A graphical depiction of a data frame. The first vector (column) is numeric; the second is character, and the third is logical." style="display: block; margin: auto;" />
</figure>
